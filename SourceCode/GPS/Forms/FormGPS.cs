    ...
    public partial class FormGPS : Form
    {
        ...
        private void BuildMachineByte()
        {
            ...
            if (bnd.bndList.Count > 0)
            {
                ...
                if (bnd.IsPointInsideFenceArea(toolPos)) section[7].isSectionOn = true;
            ...
            relays = Convert.ToString(p_254.pgn[p_254.sc1to8], 2).PadLeft(8, '0');

            if ((p_254.pgn[p_254.sc1to8] & 128) == 128) relays += " Inside (Relay 8 - On)";
            else relays += " Outside (Relay 8 - Off)";
