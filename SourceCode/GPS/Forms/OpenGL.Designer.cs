...
namespace AgOpenGPS
{
    public partial class FormGPS
    {
        ...
        private void oglMain_Paint(object sender, PaintEventArgs e)
        {
            ...
            else
            {
                if (isGPSPositionInitialized)
                {
                    ...
                    GL.BindTexture(TextureTarget.Texture2D, texture[22]);
                    GL.Begin(PrimitiveType.TriangleStrip);
                    double eastingMinGeo = minFieldXo;
                    double eastingMaxGeo = maxFieldXo;
                    double northingMinGeo = minFieldYo;
                    double northingMaxGeo = maxFieldYo;

                    GL.TexCoord2(0, 0);
                    GL.Vertex3(eastingMinGeo, northingMaxGeo, 0);
                    GL.TexCoord2(1, 0.0);
                    GL.Vertex3(eastingMaxGeo, northingMaxGeo, 0);
                    GL.TexCoord2(0.0, 1);
                    GL.Vertex3(eastingMinGeo, northingMinGeo, 0);
                    GL.TexCoord2(1, 1);
                    GL.Vertex3(eastingMaxGeo, northingMinGeo, 0);
        ...
        {
            Bitmap bmp = new Bitmap(oglZoom.Width, oglZoom.Height);
            Rectangle rect = new Rectangle(0, 0, oglZoom.Width, oglZoom.Height);
            System.Drawing.Imaging.BitmapData data =
                bmp.LockBits(rect, System.Drawing.Imaging.ImageLockMode.WriteOnly,
                             System.Drawing.Imaging.PixelFormat.Format24bppRgb);
            GL.ReadPixels(0, 0, oglZoom.Width, oglZoom.Height, PixelFormat.Bgr, PixelType.UnsignedByte,
                     data.Scan0);
            bmp.UnlockBits(data);
        ...
        private void oglBack_Resize(object sender, EventArgs e)
        {
            ...
            Matrix4 mat = Matrix4.CreatePerspectiveFieldOfView(0.06f, 1.6666666666f, 50f, 520.0f);
            GL.LoadMatrix(ref mat);
            GL.MatrixMode(MatrixMode.Modelview);
        }
        ...
        private void oglZoom_Paint(object sender, PaintEventArgs e)
        {
            ...
            if (isJobStarted)
            {
                ...
                if (oglZoom.Width != 400 || oglZoom.Width == 800)
                {
                    oglZoom.MakeCurrent();
                    ...
                    //back the camera up
                    GL.Translate(0, 0, -maxFieldDistance*1.3);
        ...
        public double maxFieldXo, maxFieldYo = 300;
            public double minFieldXo, minFieldYo =-300;
        ...
        public void CalculateMinMax()
        {
            ...
            //maxFieldXo = maxFieldX;
            //maxFieldYo = maxFieldY;
            //minFieldXo = minFieldX;
            //minFieldYo = minFieldY;
            ...
            else
            {
                ...
                double HalfMax = maxFieldDistance*1.1 / 2;
                ...
                maxFieldXo = fieldCenterX + HalfMax;
                maxFieldYo = fieldCenterY + HalfMax;
                minFieldXo = fieldCenterX - HalfMax;
                minFieldYo = fieldCenterY - HalfMax;
