...
namespace AgOpenGPS
{
    public partial class FormSteer : Form
    {
        ...
        private void FormSteer_Load(object sender, EventArgs e)
        {
            ...
            if (mf.vehicle.vehicleType == 0) pictureBox1.BackgroundImage = Properties.Resources.RadiusWheelBase;
            else if (mf.vehicle.vehicleType == 1) pictureBox1.BackgroundImage = Properties.Resources.RadiusWheelBaseHarvester;
            else if (mf.vehicle.vehicleType == 2) pictureBox1.BackgroundImage = Properties.Resources.RadiusWheelBase4WD;

            nudr.Value = (int)(Properties.Vehicle.Default.setVehicle_minTurningRadius * mf.m2InchOrCm);

            nudWB.Value = (int)(Math.Abs(Properties.Vehicle.Default.setVehicle_wheelbase) * mf.m2InchOrCm);

            nudT.Value = (int)(Math.Abs(Properties.Vehicle.Default.setVehicle_trackWidth) * mf.m2InchOrCm);
            ...
            hbULook.Value = (int)(mf.vehicle.ulookgain * 10);
            uLookLbl.Text = mf.vehicle.ulookgain.ToString("N1");

            hbUSteer.Value = (int)(mf.vehicle.usteerGain * 10);
            steerFLbl.Text = mf.vehicle.usteerGain.ToString("N1");
            ...
            hsbarLookAhead.Value = (Int16)(mf.vehicle.goalPointLookAhead * 100);
        ...
        private void Timer1_Tick(object sender, EventArgs e)
        {
            ...
            {
                lblSteerAngleActual.Text = mf.sim.steerAngle.ToString("N1") + "\u00B0";
            }
            else
            {
                lblSteerAngleActual.Text = mf.mc.actualSteerAngleDegrees.ToString("N1") + "\u00B0";
            ...
            SteerLbl.Text = ((mf.vehicle.wheelbase * 1.0 / (Math.Tan(glm.toRadians(mf.vehicle.maxSteerAngle)))) + (0)).ToString("N2");
            ToolLbl.Text = (mf.tool.halfToolWidth - mf.tool.toolOverlap+.01).ToString("N2");
            TurnLbl.Text = (mf.vehicle.minTurningRadius + (mf.vehicle.trackWidth / 2)).ToString("N2");
        }
        ...
        {
            mf.vehicle.goalPointLookAhead = hsbarLookAhead.Value * 0.01;
            lblLookAhead.Text = mf.vehicle.goalPointLookAhead.ToString();
        ...
        private void hbULook_Scroll(object sender, ScrollEventArgs e)
        {
            mf.vehicle.ulookgain = (double)hbULook.Value / 10;
            uLookLbl.Text = mf.vehicle.ulookgain.ToString("N1");
        }

        private void radioAuto_CheckedChanged(object sender, EventArgs e)
        {
            mf.vehicle.turnCase = 0;

        }

        private void radioTurn_CheckedChanged(object sender, EventArgs e)
        {
            mf.vehicle.turnCase = 1;
        }

        private void RadioAngle_CheckedChanged(object sender, EventArgs e)
        {
            mf.vehicle.turnCase = 2;
        }

        private void RadioTool_CheckedChanged(object sender, EventArgs e)
        {
            mf.vehicle.turnCase = 3;
        }

        private void nudWB_Click(object sender, EventArgs e)
        {
            if (mf.KeypadToNUD((NumericUpDown)sender, this))
            {
                Properties.Vehicle.Default.setVehicle_wheelbase = (double)nudWB.Value * mf.inchOrCm2m;
                mf.vehicle.wheelbase = Properties.Vehicle.Default.setVehicle_wheelbase;
                Properties.Vehicle.Default.Save();
            }
        }

        private void nudr_Click(object sender, EventArgs e)
        {
            if (mf.KeypadToNUD((NumericUpDown)sender, this))
            {
                Properties.Vehicle.Default.setVehicle_minTurningRadius = (double)nudr.Value * mf.inchOrCm2m;
                mf.vehicle.minTurningRadius = Properties.Vehicle.Default.setVehicle_minTurningRadius;
                Properties.Vehicle.Default.Save();
            }
        }

        private void nudT_Click(object sender, EventArgs e)
        {
            if (mf.KeypadToNUD((NumericUpDown)sender, this))
            {
                Properties.Vehicle.Default.setVehicle_trackWidth = (double)nudT.Value * mf.inchOrCm2m;
        ...
        private void hbUSteer_Scroll(object sender, ScrollEventArgs e)
        {
            mf.vehicle.usteerGain = (double)hbUSteer.Value / 10;
            steerFLbl.Text = mf.vehicle.usteerGain.ToString("N1");
        }
